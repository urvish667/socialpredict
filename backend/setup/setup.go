...
type MarketCreation struct {
	...
	MinTradesRequired          int     `yaml:"minTradesRequired" json:"minTradesRequired"`
	MinAccountAgeDays          int     `yaml:"minAccountAgeDays" json:"minAccountAgeDays"`
	MaxMarketsPerDay           int     `yaml:"maxMarketsPerDay" json:"maxMarketsPerDay"`
}
...
// UpdateEconomicsConfig updates the in-memory economic configuration
func UpdateEconomicsConfig(newConfig *EconomicConfig) {
